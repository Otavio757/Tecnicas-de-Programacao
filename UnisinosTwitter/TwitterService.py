...
class TwitterServiceFake:
    ...
    def __init__(self):
        self.tweets = [
            ...
            "qual a previsao do tempo para gravatai para hoje e o vento e a umidade e a precipitação?",
            "qual a previsao do tempo para gravatai para amanhã e o vento e a umidade e a precipitação?",
            "qual a previsao do tempo para gravatai para segunda e o vento e a umidade e a precipitação?",
            "qual a previsao do tempo para gravatai para terça e o vento e a umidade e a precipitação?",
            "qual a previsao do tempo para gravatai para domingo e o vento e a umidade e a precipitação?",
            "qual a previsao do tempo para gravatai para os proximos 10 dias e o vento e a umidade e a precipitação?",
            "qual a previsao do tempo para gravatai para os proximos 5 dias e o vento e a umidade e a precipitação?",
            "qual a previsao do tempo para gravatai para os proximos 3 dias e o vento e a umidade e a precipitação?",
            "qual a previsao do tempo para gravatai para os proximos 1 dias e o vento e a umidade e a precipitação?",
